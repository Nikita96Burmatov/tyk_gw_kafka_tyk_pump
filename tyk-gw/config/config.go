...
type KafkaOptionsConf struct {
	Addresses   []string          `json:"addresses"`
	ListenPaths []string          `json:"tyk_listen_paths"`
	Headers     map[string]string `json:"tyk_headers"`
}
...
type Config struct {
	...
	// This section defines your Kafka configuration.
	Kafka KafkaOptionsConf `json:"kafka"`
